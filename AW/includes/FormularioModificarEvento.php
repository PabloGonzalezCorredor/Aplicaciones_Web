    ...
    protected function generaCamposFormulario(&$datos) {
        ...
        <fieldset class="form">
            ...
            <div style="display: flex; align-items: center">
                ...
                <input id="localizacion" type="text" placeholder="Nombre del Evento"  name="localizacion" value="$localizacion"/>
            </div>
            {$erroresCampos['localizacion']}
            <div style="display: flex; width: 100%; justify-content: center">
                <button type="submit" class="next-button" name="modificar"><h4>Modificar Evento</h4></button>
            </div>  
        </fieldset>
        HTML;

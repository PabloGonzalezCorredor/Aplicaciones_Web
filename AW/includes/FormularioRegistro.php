...
class FormularioRegistro extends Formulario
{
    ...
    protected function generaCamposFormulario(&$datos)
    {
        ...
        $erroresCampos = self::generaErroresCampos(['nombreUsuario', 'nombre', 'imagen', 'tipo', 'password', 'password2'], $this->errores, 'span', array('class' => 'error'));
        ...
        <fieldset style="text-align:center">
            ...
            <div>
                <button type="submit" class="next-button" name="registro"><h4>Registrar<h4></button>
            </div>
        </fieldset>
        HTML;
        return $html;
    ...
    protected function procesaFormulario(&$datos)
    {
        ...
        if (count($this->errores) === 0) {
            $usuario = UsuarioSA::crea($imagenBinaria, $nombreUsuario, $password, ucfirst($nombre), $rol);

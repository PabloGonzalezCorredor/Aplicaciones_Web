...
class FormularioRegistro extends Formulario
{
    ...
    protected function generaCamposFormulario(&$datos)
    {
        ...
        $erroresCampos = self::generaErroresCampos(['nombreUsuario', 'nombre', 'tipo', 'password', 'password2'], $this->errores, 'span', array('class' => 'error'));
        ...
        <fieldset>
            ...
            <div>
                <button type="submit" name="registro"><h4>Registrar<h4></button>
            </div>
        </fieldset>
        EOF;
        return $html;
    ...
    protected function procesaFormulario(&$datos)
    {
        ...
        if (count($this->errores) === 0) {
            ...
            if ($usuario) {
                ...
                $rol = ($datos['tipo'] === "usuario") ? Usuario::USER_ROLE : Usuario::ADMIN_ROLE;
